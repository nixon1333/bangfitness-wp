...
function moove_importer_get_acf_groups( $post_type ) {
    ...
    if ( function_exists( 'acf_get_field_groups' ) ) :
        ...
        $return_values = array();
        if ( $groups ) :
            $option = '<option value="0">'.__('Select a field','moove').'</option>';
            ...
            endforeach;
            if ( $option === '' ) :
                $option = "<option value='0'>".__('No fields were found!','moove')."</option>";
                return $option;
            else :
                return $option;
            endif;
            ...
            $option = "<option value='0'>".__('No field groups defined!','moove')."</option>";
            return $option;
        endif;
    else :
...
function moove_importer_generate_foods_meta_keys($post_type){
    global $wpdb;
    $query = "
